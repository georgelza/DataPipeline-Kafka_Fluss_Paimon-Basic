...
ALTER TABLE fluss_catalog.fluss.factory_iot_north_unnested ADD PARTITION (partition_month = '202205');
ALTER TABLE fluss_catalog.fluss.factory_iot_north_unnested ADD PARTITION (partition_month = '202206');
ALTER TABLE fluss_catalog.fluss.factory_iot_north_unnested ADD PARTITION (partition_month = '202207');
ALTER TABLE fluss_catalog.fluss.factory_iot_north_unnested ADD PARTITION (partition_month = '202208');
ALTER TABLE fluss_catalog.fluss.factory_iot_north_unnested ADD PARTITION (partition_month = '202209');
ALTER TABLE fluss_catalog.fluss.factory_iot_north_unnested ADD PARTITION (partition_month = '202210');
ALTER TABLE fluss_catalog.fluss.factory_iot_north_unnested ADD PARTITION (partition_month = '202211');
ALTER TABLE fluss_catalog.fluss.factory_iot_north_unnested ADD PARTITION (partition_month = '202212');

ALTER TABLE fluss_catalog.fluss.factory_iot_north_unnested ADD PARTITION (partition_month = '202301');
ALTER TABLE fluss_catalog.fluss.factory_iot_north_unnested ADD PARTITION (partition_month = '202302');
ALTER TABLE fluss_catalog.fluss.factory_iot_north_unnested ADD PARTITION (partition_month = '202303');
ALTER TABLE fluss_catalog.fluss.factory_iot_north_unnested ADD PARTITION (partition_month = '202304');
ALTER TABLE fluss_catalog.fluss.factory_iot_north_unnested ADD PARTITION (partition_month = '202305');
ALTER TABLE fluss_catalog.fluss.factory_iot_north_unnested ADD PARTITION (partition_month = '202306');
ALTER TABLE fluss_catalog.fluss.factory_iot_north_unnested ADD PARTITION (partition_month = '202307');
ALTER TABLE fluss_catalog.fluss.factory_iot_north_unnested ADD PARTITION (partition_month = '202308');
...
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202205');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202206');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202207');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202208');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202209');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202210');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202211');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202212');

ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202301');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202302');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202303');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202304');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202305');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202306');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202307');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202308');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202309');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202310');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202311');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202312');

ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202401');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202402');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202403');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202404');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202405');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202406');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202407');
ALTER TABLE fluss_catalog.fluss.factory_iot_south_unnested ADD PARTITION (partition_month = '202408');
